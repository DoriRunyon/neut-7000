...
class TestFileTransfer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_key_a = self.test_program.create_key(name="a_key", value="0", is_storage=False)
    ...
    def test_create_key(self):
        ...
        key = self.test_program.create_key(name="a_key", value="0", is_storage=False)
    ...
    def test_create_storage_key(self):
        self.assertEqual(self.test_program.available_storage, 0)
        key = self.test_program.create_key(name="a_key", value="0", is_storage=True)
